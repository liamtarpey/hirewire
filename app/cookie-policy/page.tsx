            ...
            <PageWrap $limit="sm">
                <PageContainer>
                    <RichText>
                        <h1>Cookie Policy</h1>
                        <p>
                            This Cookie Policy governs the use of cookies on the
                            Hirewire Ltd website ("Site"). By using our website,
                        ...
                        <p>
                            ...
                            computer or mobile device by websites that you
                            visit. They are widely used to make websites work
                            more efficiently and to provide information to the
                            owners of the site.
                        </p>

                        <h2>How we use cookies</h2>
                        <p>
                            Hirewire Ltd does not use 3rd-party cookies to
                            enhance User experience and to analyse website
                            traffic. We utilise cookie-less solutions from
                            Vercel Analytics and Speed Insights to gather
                            anonymised data about website usage, performance,
                            and visitor interactions. This data help us improve
                            our website and tailor it to our users' needs.
                        </p>
                        ...
                        <p>
                            Hirewire Ltd may update this Cookie Policy from time
                            to time. We will notify you of any changes by
