...
export default function Disclaimer() {
    return (
        <>
            <h1>Disclaimer</h1>
            <p>
                Welcome to Hirewire Ltd. The information provided on this
            ...
            <p>
                ...
                services, or related graphics contained on this website. Any
            ...
            <p>
                ...
                under the control of Hirewire Ltd. We have no control over the
